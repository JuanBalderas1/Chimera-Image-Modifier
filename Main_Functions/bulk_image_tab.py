...
from Main_Functions.single_image_tab import resize_image


# --------------------------------------------------
# Bulk Image Resize configuration
# --------------------------------------------------
...
# --------------------------------------------------
# Bulk Image Resize tab
# --------------------------------------------------

class BulkImageTab(ctk.CTkFrame):
    ...
    def _build_controls_column(self):
        ...
        self.controls_column.grid_columnconfigure(
            0,
            weight=1,
        )
    ...
    def _build_output_card(self):
        ...
        self.output_card.grid_columnconfigure(
            0,
            weight=1,
        )
    ...
    def _build_preview_column(self):
        ...
        self.preview_card.grid_columnconfigure(
            0,
            weight=1,
        )

        self.preview_card.grid_rowconfigure(
            1,
            weight=1,
        )
        ...
        self.preview_panel.grid_columnconfigure(
            0,
            weight=1,
        )

        self.preview_panel.grid_rowconfigure(
            0,
            weight=1,
        )
        ...
        self.preview_label = ctk.CTkLabel(
            self.preview_panel,
            text=(
                "The first supported image in the "
                "folder will appear here"
            ),
            font=self.font_normal,
            wraplength=420,
        )
    ...
    def preview_first_image(self):
        ...
        try:
            ...
            first_image_path = (
                self._find_first_supported_image(
                    folder_path
                )
            )
    ...
    def resize_folder_images(self):
        ...
        try:
            for filename in sorted(
                ...
                # Shared resize engine from Single Image Resize.
                resize_image(
